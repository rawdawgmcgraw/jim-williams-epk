...
const Header = () => {
  return (
    <div className='absolute top-[-10] w-full flex justify-around text-white'>
      ...
      <div className='flex gap-5 items-center'>
        ...
        <a href='https://www.tiktok.com/@thejimwilliams' target='_blank'>
        ...
        <a href='https://jimwilliamsmusic.bandcamp.com/' target='_blank'>
